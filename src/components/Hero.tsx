      ...
      <div className="text-center max-w-sm mx-auto animate-fade-in">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full bg-white border border-gray-200 text-gray-700 font-medium py-3 px-8 rounded-xl text-base hover:bg-gray-50 transition-colors duration-200 hover-lift animate-bounce-gentle"
          >
            서비스 살펴보기
          </button>
        </div>
